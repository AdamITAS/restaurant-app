...
export default function CustomerMenuView({ 
  ...
  const { lang, setLang, t } = useLanguage() // Sistema di traduzione
  ...
  // Funzione helper per prendere il nome giusto in base alla lingua
  const getName = (item: MenuItem | MenuCategory) => {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-32 relative">
      ...
      <header className="sticky top-0 bg-white/80 backdrop-blur-md shadow-sm p-4 flex justify-between items-center z-10">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button 
            ...
            className="p-2 rounded-full hover:bg-slate-100 text-slate-600 text-lg"
      ...
      <div className="p-4 max-w-3xl mx-auto">
        ...
        {!filterCategory && (
          <>
            <h2 className="text-xl font-bold mb-4 text-slate-800 flex items-center gap-2">{t.topDishes}</h2>
